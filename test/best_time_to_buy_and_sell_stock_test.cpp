...
)
{
    ...
    {
        std::vector const prices{7, 19};

        CAPTURE(prices);

        REQUIRE(calc_max_profit(prices.cbegin(), prices.cend()) == 12);
    }

    SECTION("Two prices where profit is impossible")
    {
        std::vector const prices{19, 7};
    ...
    {
        std::vector const prices{5, 7, 19};

        CAPTURE(prices);

        REQUIRE(calc_max_profit(prices.cbegin(), prices.cend()) == 14);
    }

    SECTION("Three prices where profit is possible - case 2")
    {
        std::vector const prices{7, 5, 19};
    ...
    {
        std::vector const prices{19, 7, 3};
    ...
    SECTION("Thirty-two prices where profit is possible (benchmark case)")
    {
        ...
        REQUIRE(calc_max_profit(prices.cbegin(), prices.cend()) == 269);
    }
    ...
    {
        std::vector const prices{7, 1, 5, 3, 6, 4};

        CAPTURE(prices);

        REQUIRE(calc_max_profit(prices.cbegin(), prices.cend()) == 5);
    }

    SECTION("LeetCode test case 2")
    {
        std::vector const prices{7, 6, 4, 3, 1};
    ...
    {
        std::vector const prices{10, 1, 5, 6, 7, 1};

        CAPTURE(prices);

        REQUIRE(calc_max_profit(prices.cbegin(), prices.cend()) == 6);
    }

    SECTION("NeetCode test case 2")
    {
        std::vector const prices{10, 8, 7, 5, 2};
    ...
    {
        std::vector const prices{7, 10, 1, 3, 6, 9, 2};

        CAPTURE(prices);

        REQUIRE(calc_max_profit(prices.cbegin(), prices.cend()) == 8);
    }
    ...
    {
        std::vector const prices{1, 3, 6, 9, 11};

        CAPTURE(prices);

        REQUIRE(calc_max_profit(prices.cbegin(), prices.cend()) == 10);
    }
}
